...
urlpatterns = [
    ...
    path('pay-water-bill/', views.pay_water_bill, name='pay_water_bill'),
    path('pay-garbage-bill/', views.pay_garbage_bill, name='pay_garbage_bill'),
    path('pay-health-bill/', views.pay_health_bill, name='pay_health_bill'),
